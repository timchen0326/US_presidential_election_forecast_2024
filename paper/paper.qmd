...
Our primary outcome variable is the percentage of support for Kamala Harris and Donald Trump in each poll.
...
The results in @figure-2 indicate that sample size has a weak but statistically significant negative effect on support for Trump.
